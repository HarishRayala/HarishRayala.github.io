        ...
        <div className="tech-section">
          <div className="right">
            <div className="center">
              <h2 style={{fontWeight:"bold"}} >Frontend</h2>
              <div className="two">
              ...
              <h2 style={{fontWeight:"bold"}} >Backend</h2>
              <div className="two">
                <div className="icon-name">
                  <img
              ...
              <h2 style={{fontWeight:"bold"}} >Tools</h2>
              <div className="two">
                <div className="icon-name">
                  <img
                ...
                <div className="icon-name">
                  <img
                    src="https://img.icons8.com/external-tal-revivo-shadow-tal-revivo/70/null/external-netlify-a-cloud-computing-company-that-offers-hosting-and-serverless-backend-services-for-static-websites-logo-shadow-tal-revivo.png"
                    alt="netlify"
                  />
                  <p>Netlify</p>
                </div>
                <div className="icon-name">
                  <img
                    src="https://img.icons8.com/color/70/null/heroku.png"
                    alt="heroku"
                  />
                  <p>Heroku</p>
                </div>
